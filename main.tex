...
\renewcommand{\arraystretch}{1}
	...
	\textbf{Exercício 1 (Exercício 3 do livro). Calcule e justifique.}
	\begin{align*}
		\textbf{a)}\quad & \lim_{x \to 2} x^2 = 4 \quad\text{(função polinomial, contínua em } \mathbb{R}) \\
		\textbf{b)}\quad & \lim_{x \to 1} (3x + 1) = 4 \quad\text{(função polinomial, contínua em } \mathbb{R}) \\
		\textbf{c)}\quad & \lim_{x \to -2} (4x + 1) = -7 \quad\text{(função polinomial, contínua em } \mathbb{R}) \\
		\textbf{d)}\quad & \lim_{x \to 10} 5 = 5 \quad\text{(função constante, contínua em todo ponto)} \\
		\textbf{e)}\quad & \lim_{x \to -9} 50 = 50 \quad\text{(função constante)} \\
		\textbf{f)}\quad & \lim_{x \to -1} (-x^2 - 2x + 3) = 4 \quad\text{(função polinomial)} \\
		\textbf{g)}\quad & \lim_{x \to 4} \sqrt{x} = 2 \quad\text{(raiz de grau par, contínua para } x \geq 0) \\
		\textbf{h)}\quad & \lim_{x \to -3} \sqrt[3]{x} = -1,442 \quad\text{(função contínua em } \mathbb{R}) \\
		\textbf{i)}\quad & \lim_{x \to -8} \sqrt{5} = \sqrt{5} \quad\text{(expressão constante)} \\
		\textbf{j)}\quad & \lim_{x \to 3} \dfrac{x^2 - 9}{x - 3} = \lim_{x \to 3} \dfrac{(x-3)(x+3)}{x-3} = 6 \\
		& \text{Função racional, contínua após simplificação} \\
		\textbf{l)}\quad & \lim_{x \to 3} \dfrac{x^2 - 9}{x + 3} = \dfrac{(x-3)(x+3)}{x+3} = 0 \quad\text{(similar a j) )} \\
		\textbf{m)}\quad & \lim_{x \to -1} \dfrac{x^2 - 9}{x-3} = \dfrac{(x-3)(x+3)}{x-3} = 2 \\
		\textbf{n)}\quad & \lim_{x \to 1/2} \dfrac{4x^2 - 1}{2x - 1} = \dfrac{(2x-1)(2x+1)}{2x - 1} = 2 \quad\text{(função racional, contínua)} \\
		\textbf{o)}\quad & \lim_{x \to 1} \dfrac{\sqrt{x} - 1}{x - 1} = \dfrac{1}{2} \quad\text{(raiz no numerador e afim no denominador, função contínua)} \\
		\textbf{p)}\quad & \lim_{x \to -1/3} \dfrac{9x^2 - 1}{3x+1} = \dfrac{(3x-1)(3x+1)}{3x+1} = -2 \quad\text{(função polinomial, contínua)} \\
		\textbf{q)}\quad & \lim_{x \to 3} \dfrac{\sqrt{x} - \sqrt{3}}{x - 3} = \dfrac{1}{2\sqrt{3}} \quad\text{(raiz e função afim, função contínua)} \\
		\textbf{t)}\quad & \lim_{x \to 0} \dfrac{x^2 + 3x - 1}{x^2 + 2} = \dfrac{-1}{2} \quad\text{(função racional, contínua)} \\
		\textbf{u)}\quad & \lim_{x \to 1} \dfrac{\sqrt{2x + 3} - \sqrt{5}}{x - 1} = \dfrac{\sqrt{5}}{2} \quad\text{(Multiplique pelo conjugado)} \\
	\end{align*}
