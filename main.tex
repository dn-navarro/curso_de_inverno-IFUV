...
\begin{document}
	...
	\textit{[Exemplo virá aqui ...]}
	Gráfico com dois pares ordenados $(2,3)\, e \,(3,2)$. Explicar a diferença.
	...
	%% Fazer a função de outras angulos
	...
	\begin{table}[h]
		...
		\begin{tabular}{|c|c|c|}
			...
			\hline
			\( 270^\circ \) & \( \dfrac{270 \cdot \pi}{180} \)    & \( \dfrac{3\pi}{2} \) \\
			\hline
